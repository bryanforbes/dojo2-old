define(["require", "./has"], function(require, has){
	// summary:
			...
			var matchesTarget = this,
				select = typeof selector == "function" ?
					...
					function select(eventTarget){
						// see if we have a valid matchesTarget or default to dojo/query if required
						try{
							matchesTarget = matchesTarget && matchesTarget.matches ? matchesTarget : require("./query");
						}catch(e){
							throw new Error("In order to use event delegation, 'dojo/query' must be required.");
						}
